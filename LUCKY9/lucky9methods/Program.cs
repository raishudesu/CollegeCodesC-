...
public class LUCKY9
{
    ...
    static int card_sum(int y, int z)
    {
        int x;
        x = y + z;
        return x;
            ...
            try
            {
                ...
                while (playing)
                {
                    try
                    {
                        ...
                        comp_c1 = card_rndm();
                        comp_c2 = card_rndm();
                        player_sum = card_sum(player_c1, player_c2);
                        comp_sum = card_sum(comp_c1, comp_c2);
                        player_score = score(player_sum);
                        comp_score = score(comp_sum);
                        lose = cash_total - bet;
                        win = cash_total + bet;
                        if (bet > cash_total)
                        {
